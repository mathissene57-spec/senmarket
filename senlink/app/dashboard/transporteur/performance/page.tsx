...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  tuile: { border: '1px solid #E7E1D3', borderRadius: 14, padding: 16, textAlign: 'center', background: '#fff' },
  tuileValeur: { fontSize: 28, fontWeight: 900, color: '#0B2418' },
  tuileLabel: { fontSize: 12, color: '#66756D', marginTop: 4 },
  sousTitre: { fontSize: 12, fontWeight: 700, color: '#66756D', textTransform: 'uppercase', letterSpacing: 0.3, margin: '20px 0 8px' },
  list: { display: 'flex', flexDirection: 'column', gap: 8 },
  row: {
    display: 'flex', justifyContent: 'space-between', fontSize: 13.5,
    border: '1px solid #E7E1D3', borderRadius: 10, padding: '10px 14px', background: '#fff',
  },
  rowCount: { fontWeight: 700, color: '#0B2418' },
}
