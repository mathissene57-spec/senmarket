...
export default function LoginPage() {
  ...
  async function handleRegister(e: React.FormEvent) {
    ...
    // Le role par defaut ('client') est attribue cote base par le trigger
    // handle_new_user() (voir supabase/migrations) via raw_user_meta_data.role.
    const { error } = await supabase.auth.signUp({
      email: regEmail,
      password: regPwd,
      options: {
        data: { full_name: regNom, role: 'client' },
      },
    })
